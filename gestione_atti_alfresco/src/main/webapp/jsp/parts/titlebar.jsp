...
<tr>
<td style="padding-right:4px;"><a:actionLink id="about_alfresco" image="/images/logo/crl_logo_mini.png" value="#{msg.title_about}" tooltip="#{msg.title_about}" showLink="false" action="dialog:aboutDialog" /></td>
