...
public class LettereNotificheController implements Serializable{
	...
	public void init() {
		...
		letteraRettificaAssegnazione
				.setTipoTemplate("crltemplate:letteraRettificaAssegnazioneServComm");
		letteraRettificaAssegnazione
		...
		letteraAggiuntaFirma
				.setTipoTemplate("crltemplate:letteraAggiuntaFirmaServComm");
		letteraAggiuntaFirma
		...
		letteraRitiroFirma
				.setTipoTemplate("crltemplate:letteraRitiroFirmaServComm");
		letteraRitiroFirma
		...
		letteraAssestamentoBilancio
				.setTipoTemplate("crltemplate:letteraAssestamentoBilancioServComm");
		letteraAssestamentoBilancio
				.setUrlView("./lettere/servizioCommissioni/pdl/letteraAssestamentoBilancio.xhtml");
		letteraAssestamentoBilancio.setNome("Lettera assestamento bilancio");
		TreeNode nodeLetteraAssestamentoBilancio = new DefaultTreeNode(
				"lettera", letteraAssestamentoBilancio, nodeServCommPDL);

		Lettera letteraBilancioProgrammatico = new Lettera();
		letteraBilancioProgrammatico
				.setTipoTemplate("crltemplate:letteraBilancioProgrammaticoServComm");
		letteraBilancioProgrammatico
		...
		letteraIniziativaPopolare
				.setTipoTemplate("crltemplate:letteraIniziativaPopolareServComm");
		letteraIniziativaPopolare
		...
		letteraRendicontoGenerale
				.setTipoTemplate("crltemplate:letteraRendicontoGeneraleServComm");
		letteraRendicontoGenerale
		...
		letteraLeggeFinanziaria
				.setTipoTemplate("crltemplate:letteraLeggeFinanziariaServComm");
		letteraLeggeFinanziaria
				.setUrlView("./lettere/servizioCommissioni/pdl/letteraRettificaAssegnazione.xhtml");
		...
		letteraDOCassegnazionePSR
				.setTipoTemplate("crltemplate:letteraDOCAssegnazionePSRServComm");
		letteraDOCassegnazionePSR
		...
		letteraDOCassegnazioneDSA
				.setTipoTemplate("crltemplate:letteraDOCAssegnazioneDSAServComm");
		letteraDOCassegnazioneDSA
		...
		letteraParereCommissione
				.setTipoTemplate("crltemplate:letteraParereCommissioneServComm");
		letteraParereCommissione
		...
		letteraIntesaCommissioneGiunta
				.setTipoTemplate("crltemplate:letteraIntesaCommissioneGiuntaServComm");
		letteraIntesaCommissioneGiunta
		...
		letteraParerePropostaRegolamento
				.setTipoTemplate("crltemplate:letteraParerePropostaDiRegolamentoServComm");
		letteraParerePropostaRegolamento
		...
		letteraAssegnazionesedereferente
				.setTipoTemplate("crltemplate:letteraAssegnazioneInSedeReferentePDAServComm");
		letteraAssegnazionesedereferente
		...
		letteraAssegnazioneistruttoria
				.setTipoTemplate("crltemplate:letteraAssegnazionePerIstruttoriaPLPServComm");
		letteraAssegnazioneistruttoria
		...
		letteraRelazionepresentatagiunta
				.setTipoTemplate("crltemplate:letteraRelazionePresentataDallaGiuntaServComm");
		letteraRelazionepresentatagiunta
		...
		letteraAssegnazioneistruttoriaPRE
				.setTipoTemplate("crltemplate:letteraAssegnazionePerIstruttoriaPREServComm");
		letteraAssegnazioneistruttoriaPRE
		...
		letteraAssegnazioneistruttoriaREF
				.setTipoTemplate("crltemplate:letteraAssegnazionePerIstruttoriaREFServComm");
		letteraAssegnazioneistruttoriaREF
		...
		letteraAssegnazioneistruttoriaINP
				.setTipoTemplate("crltemplate:letteraAssegnazionePerIstruttoriaINPServComm");
		letteraAssegnazioneistruttoriaINP
				.setUrlView("./lettere/servizioCommissioni/pre/letteraAssegnazioneistruttoriaREF.xhtml");
		letteraAssegnazioneistruttoriaINP
				.setNome("Lettera Assegnazione per istruttoria");
		...
		letteraTrasmissionePDA
				.setTipoTemplate("crltemplate:letteraTrasmissionePDACommissioni");
		letteraTrasmissionePDA
		...
		letteraTrasmissionePDAurgenza
				.setTipoTemplate("crltemplate:letteraTrasmissionePDAUrgenzaCommissioni");
		letteraTrasmissionePDAurgenza
		...
		letteraTrasmissionePAR
				.setTipoTemplate("crltemplate:letteraTrasmissionePARCommissioni");
		letteraTrasmissionePAR
		...
		letteraTrasmissionePLP
				.setTipoTemplate("crltemplate:letteraTrasmissionePLPCommissioni");
		letteraTrasmissionePLP
		...
		letteraPresaAttoREL
				.setTipoTemplate("crltemplate:letteraPresaAttoRELCommissioni");
		letteraPresaAttoREL
		...
		letteraTrasmissioneREF
				.setTipoTemplate("crltemplate:letteraTrasmissioneREFCommissioni");
		letteraTrasmissioneREF
		...
		letteraTrasmissioneAulatestounicocompilativo
				.setTipoTemplate("crltemplate:letteraTrasmissioneAulaTestoUnico");
		letteraTrasmissioneAulatestounicocompilativo
		...
		letteratrasmissioneDOCRISDSA
				.setTipoTemplate("crltemplate:letteraTrasmissioneDocRisDsaCommissioni");
		letteratrasmissioneDOCRISDSA
		...
		letteratrasmissioneparereDOC
				.setTipoTemplate("crltemplate:letteraTrasmissioneParereSuDOCCommissioni");
		letteratrasmissioneparereDOC
		...
		letteraTrasmissioneRIS
				.setTipoTemplate("crltemplate:letteraTrasmissioneRISCommissioni");
		letteraTrasmissioneRIS
		...
		letteraTrasmissioneLCR
				.setTipoTemplate("crltemplate:letteraTrasmissioneLCRAula");
		letteraTrasmissioneLCR
		...
		letteraTrasmissionePDAAula
				.setTipoTemplate("crltemplate:letteraTrasmissionePDAAula");
		letteraTrasmissionePDAAula
		...
		letteraTrasmissionePDABilancio
				.setTipoTemplate("crltemplate:letteraTrasmissionePDABilancioAula");
		letteraTrasmissionePDABilancio
		...
		letteraTrasmissioneREFAula
				.setTipoTemplate("crltemplate:letteraTrasmissioneREFAula");
		letteraTrasmissioneREFAula
		...
		letteraTrasmissioneORG
				.setTipoTemplate("crltemplate:letteraTrasmissioneORGAula");
		letteraTrasmissioneORG
		...
		letteraConvalidaORG
				.setTipoTemplate("crltemplate:letteraConvalidaORGAula");
		letteraConvalidaORG
		...
		letteraTrasmissioneBURL
				.setTipoTemplate("crltemplate:letteraTrasmissioneBURLAula");
		letteraTrasmissioneBURL
	...
	public StreamedContent getFile() {
		...
		if (letteraSelected.getTipoTemplate() != null
				&& !letteraSelected.equals("")) {
			...
			InputStream stream = lettereNotificheServiceManager.getLetteraFile(letteraSelected, attoBean.getAtto().getId(), 
					userBean.getUser().getSessionGroup().getNome());
			StreamedContent file = new DefaultStreamedContent(stream,
					"document", letteraSelected.getNome()+".doc");
			return file;
		} else {
