...
<body>
	...
	<form action="/alfresco/service/crl/protocollo/atto/allegato/insert?alf_ticket=${session.ticket}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
	<table>
		<tr>
			<td>
				Atto:
