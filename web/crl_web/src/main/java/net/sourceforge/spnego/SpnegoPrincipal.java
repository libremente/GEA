 ...
 * 
 * <p>
 * This class also has a reference to the client's/requester's delegated
 * credential (if any). See the {@link DelegateServletRequest} documentation for
 * more details.
 * </p>
 * 
 * <p>
 * Also, see the delegation examples at
...
public final class SpnegoPrincipal implements Principal {
	...
	/**
	 * Constructs a SpnegoPrincipal from the provided String input and name type
	 * input.
	 * 
	 * @param name     the principal name
