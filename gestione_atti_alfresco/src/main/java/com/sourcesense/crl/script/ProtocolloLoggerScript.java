...
/**
 * Personalizzazione del logger per ProtocolloLogger
 * @author sourcesense
 *
 */
public class ProtocolloLoggerScript extends BaseScopableProcessorExtension {

	
	private static Log logger = LogFactory.getLog(ProtocolloLoggerScript.class);
