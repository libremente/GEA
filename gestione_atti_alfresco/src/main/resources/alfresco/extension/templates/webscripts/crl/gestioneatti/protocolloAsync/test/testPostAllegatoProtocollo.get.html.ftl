...
<body>
	...
	<form action="/alfresco/service/crl/protocollo/async/atto/allegato/insert?alf_ticket=${session.ticket}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
	<table>
		<tr>
			<td>
				ID protocollo atto:
