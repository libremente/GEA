...
if(checkIsNotNull(legislatura)
	...
	if(checkIsNotNull(esibenteMittente)){
		...
		if(tipoIniziativa=="01_ATTO DI INIZIATIVA CONSILIARE"){
			...
			/**
			 * CONSIGLIERI REGIONALI: <nome1> <cognome1>, <nome2> <cognome2>, É.. (<gruppo appartenenza>) -
			 *	<nome1> <cognome1>, <nome2> <cognome2>, É.. (<gruppo appartenenza>) É..
			 */
			 ...
			 * 
				...
				I Ð II III Ð IV Ð V VI VII VIII COMMISSIONE CONSILIARE ( una sola Commissione per tipo atto)
