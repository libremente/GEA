...
public class CommissioneServiceManager implements ServiceManager {
	...
	public TestoAtto uploadTestoAttoVotatoEsameCommissioni(Atto atto, InputStream stream, TestoAtto testoAtto) {
		...
		return commissioneService.uploadTestoAtto(urlBuilder.buildAlfrescoURL("alfresco_context_url", "alf_upload_testo_atto_commissione", new String[] { atto.getId() }), atto,
				stream, testoAtto, TestoAtto.TESTO_ESAME_COMMISSIONE_VOTAZIONE);
	}

	public Allegato uploadEmendamentoEsameCommissioni(Atto atto, InputStream stream, Allegato testoAtto) {

		return commissioneService.uploadAllegato(urlBuilder.buildAlfrescoURL("alfresco_context_url", "alf_upload_allegato_commissione", new String[] { atto.getId() }), atto,
				stream, testoAtto, Allegato.TIPO_ESAME_COMMISSIONE_EMENDAMENTO);
	}

	public Allegato uploadTestoComitatoRistretto(Atto atto, InputStream stream, Allegato testoAtto) {

		return commissioneService.uploadAllegato(urlBuilder.buildAlfrescoURL("alfresco_context_url", "alf_upload_testo_comitato_ristretto", new String[] { atto.getId() }), atto,
				stream, testoAtto, Allegato.TESTO_ESAME_COMMISSIONE_COMITATO);
	}

	public Allegato uploadTestoClausolaEsameCommissioni(Atto atto, InputStream stream, Allegato testoAtto) {

		return commissioneService.uploadAllegato(urlBuilder.buildAlfrescoURL("alfresco_context_url", "alf_upload_allegato_commissione", new String[] { atto.getId() }), atto,
				stream, testoAtto, Allegato.TESTO_ESAME_COMMISSIONE_CLAUSOLA);
	}

	public Allegato uploadAllegatoNoteAllegatiEsameCommissioni(Atto atto, InputStream stream, Allegato allegato) {

		return commissioneService.uploadAllegato(urlBuilder.buildAlfrescoURL("alfresco_context_url", "alf_upload_allegato_commissione", new String[] { atto.getId() }), atto,
				stream, allegato, Allegato.TIPO_ESAME_COMMISSIONE_ALLEGATO);
	}
	...
	public void removeAbbinamento(String idAtto, String idAttoAbbinato, String lastPassaggio) {
		commissioneService.removeAbbinamento(urlBuilder.buildAlfrescoURL("alfresco_context_url", "alf_delete_abbinamento_esame_commissioni", new String[] { idAtto, idAttoAbbinato,
				lastPassaggio }));
	}
	...
	public List<Commissione> findCommissioniByAtto(String idAtto) {
		...
		List<CommissioneReferente> commissioniRef = commissioneService.retrieveCommissioniReferenteByAtto(urlBuilder.buildAlfrescoURL("alfresco_context_url", "alf_new_atto",
				new String[] { idAtto }));

		List<CommissioneConsultiva> commissioniCons = commissioneService.retrieveCommissioniConsultiveByAtto(urlBuilder.buildAlfrescoURL("alfresco_context_url", "alf_new_atto",
				new String[] { idAtto }));
	...
	public List<Commissione> getAllCommissioni() {
		...
		return commissioneService.getAllCommissioni(urlBuilder.buildAlfrescoURL("alfresco_context_url", "alf_list_commissioni", null));
	 ...
	 * commissioneService.getAllCommissioneReferente
	 * (urlBuilder.buildAlfrescoURL("alfresco_context_url",
	 * "alf_list_commissioni_referenti",null));
	 * 
	 * for (CommissioneReferente commissioneReferente :
	 * listCommissioniReferenti) {
	 * 
	 ...
	 * commissioneService
	 * .getAllCommissioneConsultiva(urlBuilder.buildAlfrescoURL
	 * ("alfresco_context_url", "alf_list_commissioni_consultive", null));
	 * 
	 * for (CommissioneConsultiva commissioneConsultiva :
	 * listCommissioniConsultive)
	 * 
