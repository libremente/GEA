...
<body>
	<div>
		<h1>Test parere upload</h1>
	</div>
	
	<form action="/alfresco/service/crl/atto/pareri/allegato?alf_ticket=${session.ticket}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
	<table>
		<tr>
			<td>
				Atto:
		...
		<tr>
			...
			<td>
				<input name="organismoStatutario"/>
			</td>
		</tr>
		<tr>
			<td>
