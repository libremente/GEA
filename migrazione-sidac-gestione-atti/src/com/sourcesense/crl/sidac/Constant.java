...
public class Constant {
	...
	public static String QUERY_ALL_ATTI = " SELECT  ag.ID as ID_ATTO_APPO , delc.*, ag.*, pc.*,alg.*, ti.DESCRIZIONE as TIPO_INIZIATIVA, le.NUM_ROMANO as LEGISLATURA," +
			...
			" TIPI_AMMISSIBILITA tipa , DELIBERE_CONSIGLIO delc , QUORUM qo , ATTI_LNK_GIUNTA alg , RINVII_IN_COMMISSIONE riic " +
	...
	//IGNOTI ATTI_GENERALE contatto, elena.casati@consiglio.regione.etc
	//TIPO_CHIUSURA non valorizzato su DB
	...
	public static String COLUMN_DATA_TRASM_CONS ="DATA_TRASM_CONS";  //sempre null
	public static String COLUMN_COLLEGAMENTO_ALTRI_ATTI ="COLLEGAMENTO_ALTRI_ATTI";
	//IGNOTI
	
	//TODO JOIN 
	//TODO JOIN ID_APPARTENENZA
	//TODO JOIN ID_PROTOCOLLO
	//TODO JOIN ID_PROTOCOLLO //Stringa senza standard
	//TODO JOIN ID_TESTO
	
	
	
	//PASSAGGI_CONSIGLIO (dati aula)
	public static String PC_COLUMN_DATA_RICHIESTA_ISCRIZIONE="DATA_RICHIESTA_ISCRIZIONE";
	public static String PC_COLUMN_PRESENZA_RELAZIONE="PRESENZA_RELAZIONE";//non corrisponde è un boolean
	public static String PC_COLUMN_CONTROLLO="CONTROLLO";//non corrisponde è un boolean
	...
	public static String PC_COLUMN_RINVIATO="RINVIATO";//non corrisponde è un boolean
	
	
	//DELIBERE_CONSIGLIO (dati aula)
	public static String DC_COLUMN_QUORUM = "QUORUM_AULA"; //CHAR(36BYTE)
	public static String DC_COLUMN_TITOLO= "TITOLO";	//VARCHAR2(50BYTE) Tutti null
	public static String DC_COLUMN_NUM_DCR = "NUM_DCR";	//VARCHAR2(30BYTE) 
	public static String DC_COLUMN_DATA_DCR	= "DATA_DCR"; //DATE // ?non la consideriamo?
	public static String DC_COLUMN_NUM_LCR = "NUM_LCR";	//VARCHAR2(50BYTE)
	public static String DC_COLUMN_DATA_LCR = "DATA_LCR";	//DATE ?non la consideriamo?
	...
	public static String DC_COLUMN_PUBBLICARE	= "PUBBLICARE";//CHAR Sarà questo il pubblico?????
	public static String DC_COLUMN_TESTO	= "TESTO";//VARCHAR2  sempre null
	public static String DC_COLUMN_VOTO_AULA = "VOTO_AULA";	//CHAR  Chiedere a quale totale si riferisce
	...
	/*
	 * ID	CHAR(36BYTE)	No	
ID_PASSAGGIO	CHAR(36BYTE)	No	
ID_SEDUTA	CHAR(36BYTE)	No	
	Yes	
ID_TESTO	CHAR(36BYTE)	Yes	
	
DATA_RICHIESTA_VISTO	DATE	Yes	
PROT_RICHIESTA_VISTO	VARCHAR2(20BYTE)	Yes	
ID_DOC_RICHIESTA_VISTO	CHAR(36BYTE)	Yes	
DATA_ACCUSA_RICEVUTA	DATE	Yes	
PROT_ACCUSA_RICEVUTA	VARCHAR2(10BYTE)	Yes	
DATA_VISTO	DATE	Yes	
PROT_VISTO	VARCHAR2(10BYTE)	Yes	
PROT_RICEZIONE_VISTO	VARCHAR2(20BYTE)	Yes	
DATA_RICEZIONE_VISTO	DATE	Yes	
ESITO_VISTO	VARCHAR2(36BYTE)	Yes	
ID_DOC_RICEZIONE_VISTO	CHAR(36BYTE)	Yes	
DATA_SCADENZA_VISTO	DATE	Yes	
ID_ATTO_LCR	CHAR(36BYTE)	Yes	
...
(36BYTE)	Yes
	...
	public static String QUERY_ORGANISMI =  " SELECT org.NOME_ORGANO , ricpar.DATA_RICHIESTA , ricpar.DATA_RICEZIONE "+
											" FROM RICHIESTA_PARERI ricpar , ORGANI_ESTERNI org "+
											" WHERE ricpar.ID_ATTO =  ? "+
	...
	public static String QUERY_COLLEGAMENTO ="SELECT  1 "+
	...
	public static String QUERY_COMMISSIONI_PASSAGGIO1 = 
	 " SELECT   ass.ID as ID_ATTO, co.descrizione  as COMM_NOME, stat_ass.descrizione as STATO_ASSEGNAZIONE, " +
	 " stat_com.descrizione as STATO_COMM ,st_voto.DESCRIZIONE as VOTO_COM, " +
	 ...
	 " STATI st_voto,ATTI_SEGUITO atseg ,PASSAGGI_COMMISSIONI pascom " +
	 " WHERE ag.ID = ? " +
	...
	public static String COMM_COLUMN_DATA_FIRMA = "DATA_FIRMA"; //???data assegnazione
	public static String COMM_COLUMN_PROT_PROPOSTA = "PROT_PROPOSTA"; //Chiedere
	public static String COMM_COLUMN_STATO_ASSEGNAZIONE = "STATO_ASSEGNAZIONE"; //Non ci interessa
	public static String COMM_COLUMN_TIPO_COMPETENZA = "TIPO_COMPETENZA"; // R U C G ??? chiedere U G 
	public static String COMM_COLUMN_DELIBERANTE = "DELIBERANTE"; //
	public static String COMM_COLUMN_PARERE_OBBLIGATORIO = "PARERE_OBBLIGATORIO"; //non lo usiamo
	public static String COMM_COLUMN_STATO_COMM = "STATO_COMM"; //
	public static String COMM_COLUMN_TIPO = "TIPO"; //R U C X G ???? Chiedere
	public static String COMM_COLUMN_DATA_ARRIVO = "DATA_ARRIVO"; //Data presa in carico
	...
	public static String COMM_COLUMN_DATA_RICH_ISCR_CONS = "DATA_RICH_ISCR_CONS"; // iscrizione aula
...
ID	CHAR(36BYTE)	No	
ID_ATTO	CHAR(36BYTE)	No	
NUM_PROPOSTA	NUMBER(10,0)	Vale l'ultimo , non hanno data annullo
ID_DOC_PROPOSTA	CHAR(36BYTE)	Documento???	
TIPO_PROPOSTA	CHAR(1BYTE)	Yes	Non abbiamo questo concetto chiedere
ATTESA_PARERE	CHAR(1BYTE)	Yes	Non abbiamo questo concetto chiedere
ID_STATO	CHAR(36BYTE)	No	

ASSEGNAZIONI_LNK_COMMISSIONI

ID	CHAR(36BYTE)	No	
ID_ASSEGNAZIONE	CHAR(36BYTE)	No	
ID_COMMISSIONE	CHAR(36BYTE)	No	
 
ATTI_SEGUITO

ID	CHAR(36BYTE)	No	
ID_ATTO_GENERALE	CHAR(36BYTE)	Yes	
ID_COMMISSIONE	CHAR(36BYTE)	Yes	
ID_STATO	CHAR(36BYTE)	No	
TIPO	VARCHAR2(50BYTE)	Yes	
...
ID	CHAR(36BYTE)	No	
ID_SEGUITO	CHAR(36BYTE)	No	
ID_TESTO_PROPOSTO	CHAR(36BYTE)	Yes	
ID_SEDUTA_ARRIVO	CHAR(36BYTE)	Yes	
ID_SEDUTA_VOTO	CHAR(36BYTE)	Yes	 
ID_TESTO_LICENZIATO	CHAR(36BYTE)	Yes	
ID_ABBINAMENTO	CHAR(36BYTE)	Yes	
ID_COMITATO_RISTR	CHAR(36BYTE)	Yes	
NUM_PASSAGGIO	NUMBER(10,0)	No	1
