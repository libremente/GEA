...
public final class SpnegoProvider {
	 ...
	 * 
	 * <p>
	 * This method may return null in which case you must check the HTTP Status Code
	 * to determine if additional processing is required. <br />
	 * For example, if req. did not contain the Constants.AUTHZ_HEADER, the HTTP
	 * Status Code SC_UNAUTHORIZED will be set and the client must send
	 ...
	 * @throws IOException
	 */
	static SpnegoAuthScheme negotiate(final HttpServletRequest req, final SpnegoHttpServletResponse resp,
			final boolean basicSupported, final boolean promptIfNtlm, final String realm) throws IOException {
	...
	public static GSSCredential getClientCredential(final Subject subject) throws PrivilegedActionException {
		...
		final PrivilegedExceptionAction<GSSCredential> action = new PrivilegedExceptionAction<GSSCredential>() {
			public GSSCredential run() throws GSSException {
				return MANAGER.createCredential(null, GSSCredential.DEFAULT_LIFETIME, SpnegoProvider.SPNEGO_OID,
	...
	public static GSSContext getGSSContext(final GSSCredential creds, final URL url) throws GSSException {
		...
		return MANAGER.createContext(SpnegoProvider.getServerName(url), SpnegoProvider.SPNEGO_OID, creds,
	...
	static GSSCredential getServerCredential(final Subject subject) throws PrivilegedActionException {
		...
		final PrivilegedExceptionAction<GSSCredential> action = new PrivilegedExceptionAction<GSSCredential>() {
			public GSSCredential run() throws GSSException {
				return MANAGER.createCredential(null, GSSCredential.INDEFINITE_LIFETIME, SpnegoProvider.SPNEGO_OID,
