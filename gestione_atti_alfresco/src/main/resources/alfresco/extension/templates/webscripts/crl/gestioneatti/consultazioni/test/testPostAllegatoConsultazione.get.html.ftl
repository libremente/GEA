...
<body>
	<div>
		<h1>Test consultazione upload</h1>
	</div>
	
	<form action="/alfresco/service/crl/atto/consultazioni/allegato?alf_ticket=${session.ticket}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
	<table>
		<tr>
			<td>
				Atto:
